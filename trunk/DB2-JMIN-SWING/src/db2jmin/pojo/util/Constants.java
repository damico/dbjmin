...
/**
 * This class intents to hold all application Constants
 * 
...
public interface Constants {
	...
	public static final String APPNAME = "DBJMIN - 0.5 (RC3)";
	...
	public static final String TEMP_ALIVE_CREDENTIAL = "dbjmin.properties"; // add
																			// to
																			// xml
	public static final int SELECT_LIMIT = 1500; // add to xml
	public static final String[] UNIXES_DEFAULT_BROWSERS = { "firefox",
			"iceweasel" };
	...
	public static final String HTML_BOTTON = "<hr>" + "" + APPNAME
			+ "</body>\n" + "</html>";
