...
public class Schemas extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		ArrayList<String> schemas = ActionsFactory.callJetty(null,
				Constants.W_SCHEMA_ACTION).getResult();
		...
		out.println("<tr bgcolor='#CCCCCC'><td><b>Schemas (" + schemas.size()
				+ ")</b></td></tr>\n");
		for (int i = 0; i < schemas.size(); i++) {
			out.println("<tr><td><a href='/tables?s=" + schemas.get(i) + "'>"
					+ schemas.get(i) + "</a></td></tr>\n");
		}
		out.println("</table>");
		if (schemas.size() < 1) {
			out
					.println("<br><br><table bgcolor = 'black' width='300'>"
