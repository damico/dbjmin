...
public class LogConsole  extends JFrame {
	...
	public class ReaderThread extends Thread {
		...
		private String logPath = SystemOper.singleton().getTempPath()+Constants.LOGNAME+".log"; 
		private int lines = 0; 
		...
		public void run() {
			...
			while(true){
				...
				try {
					...
					if(!isVisible()){
						System.out.println("LogConsole ["+this.getName()+"] thread killed.");
						return;
					}
				...
				if(tLines < readLogLines())	textArea.append(getDiffLog(tLines).toString());
			}
