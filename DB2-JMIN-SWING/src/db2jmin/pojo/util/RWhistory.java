...
/**
 *This class creates a file called "dbash_history.txt" Write/Read the commands
 * SQL stored in a "dbash_history.txt"
 * 
 * */
...
public class RWhistory {
	...
	public void writeFile(String $text) {
		String text = $text;
		try {
			BufferedWriter bw = new BufferedWriter(new FileWriter(fileHistory,
					true));
