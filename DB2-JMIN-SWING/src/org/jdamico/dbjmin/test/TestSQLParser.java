...
public class TestSQLParser extends TestCase {
	...
	private String sql = "INSERT INTO jforum_groups ( group_id, group_name, group_description ) VALUES (1, 'General', 'General Users');" +
			"INSERT INTO jforum_groups ( group_id, group_name, group_description ) VALUES (2, 'Administration', 'Admin Users');" +
			"INSERT INTO jforum_users ( user_id, username, user_password, user_regdate ) VALUES (1, 'Anonymous', 'nopass', CURRENT DATE);" +
			"INSERT INTO jforum_users ( user_id, username, user_password, user_regdate, user_posts ) VALUES (2, 'Admin', '21232f297a57a5a743894a0e4a801fc3', CURRENT DATE, 1);" +
			...
			"INSERT INTO jforum_role_values (role_id, role_value) VALUES (1, '1');" +
			...
			"INSERT INTO jforum_role_values (role_id, role_value ) VALUES (5, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_category', 2);" +
			"INSERT INTO jforum_role_values (role_id, role_value ) VALUES (6, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_read_only_forums', 1);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (7, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_read_only_forums', 2);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (8, '1');" +
			"INSERT INTO jforum_roles (name, group_id ) VALUES ('perm_html_disabled', 1);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (9, '1');" +
			"INSERT INTO jforum_roles (name, group_id ) VALUES ('perm_html_disabled', 2);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (10, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_attachments_enabled', 1);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (11, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_attachments_enabled', 2);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (12, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_reply_only',  1);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (13, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_reply_only', 2);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (14, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_reply_without_moderation',  1);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (15, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_reply_without_moderation', 2);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (16, '1');" +
			"INSERT INTO jforum_roles (name, group_id) VALUES ('perm_moderation_forums', 2);" +
			"INSERT INTO jforum_role_values ( role_id, role_value ) VALUES (17, '1');";
	
	
	
	public void testBreakSQL(){
		SQLParser test = new SQLParser();
		ArrayList<String> result = test.breakSql(sql);
