...
public class SampleData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		ArrayList data = ActionsFactory.callJetty(form_data,
				Constants.W_SAMPLEDATA_ACTION).getResult();
		...
		out.println(ServletUtils.getInstance().getCommonHeader("Sample Data",
				schema, table, Constants.SCHEMA_STRUCTURE));
		...
		if (error.equals("")) {
			...
			out.println("<table bgcolor = 'black' width='500'>"
					+ "<tr valign='top'><td><font color = 'red'><b>" + error
					+ "</b></font></td></tr></table>");
